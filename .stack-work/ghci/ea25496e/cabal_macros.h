...
/* package asteroidsArena-0.1.0.0 */
#ifndef VERSION_asteroidsArena
#define VERSION_asteroidsArena "0.1.0.0"
#endif /* VERSION_asteroidsArena */
#ifndef MIN_VERSION_asteroidsArena
#define MIN_VERSION_asteroidsArena(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_asteroidsArena */
